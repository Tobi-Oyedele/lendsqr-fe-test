    ...
    <section className={styles.page}>
      ...
      <div className={styles.summaryCard}>
        ...
        <div className={styles.summaryTop}>
          ...
          <div className={`${styles.summaryBlock} ${styles.summaryDivider}`}>
        ...
        {/* Tabs pinned at bottom INSIDE card */}
      ...
      {activeTab === "general" ? (
        <div className={styles.detailsCard}>
          ...
          <Section title="Personal Information">
            ...
            <Info
              ...
              value={user.details.residenceType}
            />
          </Section>
        ...
        <div className={styles.detailsCard}>
          <p className={styles.notProvided}>
            This section is not provided in this assessment.
          </p>
        </div>
      )}
    </section>
